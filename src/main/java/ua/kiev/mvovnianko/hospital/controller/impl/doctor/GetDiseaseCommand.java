...
public class GetDiseaseCommand implements Command {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        LOGGER.debug("Command GetDisease starts");
        ...
        try {
            ...
            diseases = SERVICE.getDiseasesPage(sortBy, doctor.getId(), (page - 1) * recordsPerPage, recordsPerPage);
            LOGGER.info("diseases page reads from db");
            int noOfRecords = SERVICE.countDiseasesByDoctorId(doctor.getId());
        ...
        LOGGER.debug("Command GetDisease finished");
        return DOCTOR_PAGE;
    }
}
